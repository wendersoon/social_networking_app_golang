...
function editar(evento){
    ...
    $.ajax({
        ...
        Swal.fire("Sucesso!", "Usuario atualizado com sucesso!", "success").then(function(){
...
function deletarUsuario(evento){
    Swal.fire({
        ...
        Swal.fire({
            title: "Último Aviso!", 
            text: "Ação irreversível! Você está indo para o lado Sombrio da Força!", 
            showCancelButton: true,
            cancelButtonText: "Cancelar",
            icon: "warning"
        }).then(function(confirmacao){
            ...
            if (confirmacao.value){
               $.ajax({
                ...
                Swal.fire("Sucesso!","Você excluiu seu usuário com sucesso!","success")
                .then(function(){
